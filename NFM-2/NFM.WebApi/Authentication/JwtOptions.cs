...
namespace Centric.Finance.Infrastructure.Authorization;
...
public class JwtOptions
{
    ...
    /// <summary>
    /// Set the timespan the token will be valid for (default is 9 hours).
    /// </summary>
    public TimeSpan ValidFor { get; set; } = TimeSpan.FromMinutes(60 * 9);
    ...
    public static string JtiGenerator => Guid.NewGuid().ToString();
